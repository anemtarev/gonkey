...
- `-redis_addr <...>` when using Redis - connection address in a form of `host:port`
...
List of supported datastructures:
  ...
  sets:
    ...
    - $name: childSetTemplate
      ...
      values:
        b:
  maps:
    - $name: parentMapTemplate
      values:
        a: 1
        b: 2
    - $name: childMapTemplate
      $extend: parentMapTemplate
      values:
        c: 3
        d: 4
databases:
