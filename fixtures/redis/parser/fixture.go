...
// Hashes represent hash data structures, that will be loaded into Redis database
type Hashes struct {
...
// Lists represent Redis links data structures
type Lists struct {
...
// ZSets represent Redis sorted sets
type ZSets struct {
